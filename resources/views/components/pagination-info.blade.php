    ...
    @if ($paginator->hasPages())
        <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between">
            ...
            <div class="flex justify-between flex-1 sm:hidden">
                ...
                @else
                    <a href="{{ $paginator->previousPageUrl() }}" class="relative inline-flex items-center px-4 py-3 text-xs font-black text-cyan-600 uppercase tracking-widest bg-white border border-gray-100 rounded-2xl leading-5 hover:bg-cyan-50 focus:outline-none transition-all shadow-sm active:scale-95">
                        &laquo; Prev
                    </a>
                @endif

                @if ($paginator->hasMorePages())
                    <a href="{{ $paginator->nextPageUrl() }}" class="relative inline-flex items-center px-4 py-3 ml-3 text-xs font-black text-cyan-600 uppercase tracking-widest bg-white border border-gray-100 rounded-2xl leading-5 hover:bg-cyan-50 focus:outline-none transition-all shadow-sm active:scale-95">
                        Next &raquo;
                    </a>
                @else
