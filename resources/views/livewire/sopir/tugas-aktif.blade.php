                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center gap-4 mt-3">
                                            <span class="flex items-center text-xs font-semibold text-gray-500">
                                                ...
                                                {{ \Carbon\Carbon::parse($task->tanggal_mulai)->translatedFormat('d M') }} - {{ \Carbon\Carbon::parse($task->tanggal_selesai)->translatedFormat('d M') }}
                                            </span>
                                            <span class="flex items-center text-xs font-semibold text-gray-500">
                                                    ...
                                                    <div class="flex justify-between items-start mb-2">
                                                        <div>
                                                            ...
                                                            <p class="text-[10px] font-bold text-gray-400 mt-0.5 uppercase tracking-widest">
                                                                ...
                                                                {{ $waktu->translatedFormat('d M Y - H:i') }} ({{ $waktu->diffForHumans() }})
                                                            </p>
                                                        </div>
                                                    </div>
