            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="hover:bg-cyan-50/20 transition-colors group">
                    ...
                    <td class="px-8 py-6">
                        ...
                        <div class="text-[10px] font-mono text-cyan-600 font-bold mt-1">{{ $item->peminjaman->mobil->plat_nomor ?? 'N/A' }}</div>
                    </td>
                    <td class="px-8 py-6">
            ...
            <form wire:submit.prevent="{{ $isEditMode ? 'update' : 'store' }}">
                ...
                <div class="p-10 space-y-8 max-h-[70vh] overflow-y-auto custom-scrollbar">
                    ...
                    <div class="group" x-data="{
                        ...
                        rentals: {{ $active_rentals->map(fn($r) => ['id' => $r->id, 'text' => strtoupper($r->user->name).' - '.$r->mobil->plat_nomor])->values()->toJson() }},
                        get filteredRentals() {
            ...
            <div class="p-10 space-y-8">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="bg-gray-50 p-5 rounded-2xl border border-gray-100">
                        ...
                        <p class="text-[10px] font-mono text-cyan-600 font-bold mt-1">{{ $selectedPengembalian->peminjaman->mobil->plat_nomor }}</p>
                    </div>
                </div>
