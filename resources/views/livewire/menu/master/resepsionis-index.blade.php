<div class="p-8 space-y-10 bg-[#f9fafb] min-h-screen font-inter">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b border-gray-200 pb-8">
        <div class="flex items-center gap-5">
            ...
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight leading-none uppercase ">Data Resepsionis</h1>
                            ...
                            <td class="px-8 py-6 text-right">
                                <div class="flex justify-end gap-3">
                                    ...
                                    @can('delete-resepsionis')
                                        <button onclick="confirm('Hapus data resepsionis dan akun user ini secara permanen?') || event.stopImmediatePropagation()"
                    ...
                    <form wire:submit.prevent="{{ $isEditMode ? 'update' : 'store' }}">
                        ...
                        <div class="p-10 space-y-8 max-h-[70vh] overflow-y-auto custom-scrollbar bg-white">
                            ...
                            <div class="group">
                                ...
                                <input wire:model.live.debounce.300ms="email" type="email"
                                    ...
                                    placeholder="resepsionis@mail.com">
                                @error('email')
                                    <span class="text-rose-500 text-[10px] font-black uppercase mt-2 ml-1 flex items-center gap-1 tracking-widest">
                                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                        {{ $message }}
                        ...
                        <div class="bg-gray-50/80 px-10 py-8 flex flex-row-reverse gap-4 border-t border-gray-100 rounded-b-[2.5rem]">
                            <button type="submit" wire:loading.attr="disabled"
                                class="inline-flex justify-center rounded-2xl px-12 py-4 bg-cyan-600 text-xs font-black text-white hover:bg-cyan-700 shadow-xl shadow-cyan-100 transition-all uppercase tracking-[0.2em] leading-none disabled:opacity-50 disabled:cursor-not-allowed">
