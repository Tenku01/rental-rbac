                ...
                <form wire:submit.prevent="{{ $isEditMode ? 'update' : 'store' }}">
                    ...
                    <div class="bg-white p-10 max-h-[70vh] overflow-y-auto custom-scrollbar">
                        <div class="space-y-8">
                            ...
                            <div class="group">
                                <label class="block text-[11px] font-black text-gray-400 uppercase tracking-[0.2em] mb-3 ml-1 group-focus-within:text-cyan-600 transition-colors">Nama Lengkap</label>
                                <input wire:model="nama" type="text" class="w-full h-14 rounded-2xl border-gray-100 bg-gray-50/50 px-6 focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/10 font-bold text-gray-800 transition-all">
                                @error('nama') <span class="text-rose-500 text-[10px] font-black uppercase mt-2 ml-1 block tracking-widest">{{ $message }}</span> @enderror
                            </div>

                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div class="group">
                                    <label class="block text-[11px] font-black text-gray-400 uppercase tracking-[0.2em] mb-3 ml-1 group-focus-within:text-cyan-600 transition-colors">Alamat Email</label>
                                ...
                                <div class="group">
                                    <label class="block text-[11px] font-black text-gray-400 uppercase tracking-[0.2em] mb-3 ml-1 group-focus-within:text-cyan-600 transition-colors">Nomor Telepon / WA</label>
                                    <input wire:model="no_telepon" type="number" class="w-full h-14 rounded-2xl border-gray-100 bg-gray-50/50 px-6 focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/10 font-bold text-gray-800 transition-all">
                            ...
                            <div class="group">
                                <label class="block text-[11px] font-black text-gray-400 uppercase tracking-[0.2em] mb-3 ml-1 group-focus-within:text-cyan-600 transition-colors">Alamat Lengkap</label>
                                <textarea wire:model="alamat" class="w-full h-28 rounded-2xl border-gray-100 bg-gray-50/50 p-6 focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/10 font-bold text-gray-800 text-sm transition-all" placeholder="Jalan, Kelurahan, Kecamatan..."></textarea>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div class="group">
                                    <label class="block text-[11px] font-black text-gray-400 uppercase tracking-[0.2em] mb-3 ml-1 group-focus-within:text-cyan-600 transition-colors">Password @if($isEditMode) <span class="lowercase font-medium opacity-60">(Opsional)</span> @endif</label>
                                ...
                                <div class="group">
                                    <label class="block text-[11px] font-black text-gray-400 uppercase tracking-[0.2em] mb-3 ml-1 group-focus-within:text-cyan-600 transition-colors">Konfirmasi Password</label>
                            ...
                            <div class="md:col-span-2 space-y-4">
                                <label class="block text-[11px] font-black text-gray-400 uppercase tracking-[0.2em] mb-2 text-center">Status Keaktifan</label>
                                <div class="flex gap-6">
                                    ...
                                    <label class="flex-1 flex items-center justify-center h-16 rounded-2xl border-2 cursor-pointer transition-all shadow-sm {{ $status === 'tidak aktif' ? 'border-rose-500 bg-rose-50/50 text-rose-700 ring-4 ring-rose-500/10' : 'border-gray-100 hover:border-rose-200' }}">
                                        <input type="radio" wire:model="status" value="tidak aktif" class="hidden">
                                        <span class="text-xs font-black uppercase tracking-[0.2em]">Nonaktif</span>
                                    </label>
                                </div>
                                @error('status') <span class="text-rose-500 text-[10px] font-black uppercase mt-2 ml-1 block tracking-widest text-center">{{ $message }}</span> @enderror
                            </div>
