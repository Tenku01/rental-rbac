        ...
        <table class="w-full text-left">
            <thead class="bg-cyan-50/50 border-b border-gray-100">
                <tr>
                    ...
                    <th class="px-8 py-5 text-[11px] font-extrabold text-cyan-600 uppercase tracking-[0.15em]">Akun Email</th>
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="hover:bg-cyan-50/10 transition-colors group">
                    ...
                    <td class="px-8 py-6">
                        <div class="text-xs font-bold text-gray-600">{{ $item->user->email ?? 'No Email' }}</div>
                    </td>
                    ...
                    <td class="px-8 py-6 text-right">
                        <div class="flex justify-end gap-2">
                            ...
                            @can('delete-staff')
                            <button wire:confirm="Hapus staff dan akun ini?" wire:click="delete({{ $item->id }})" class="p-2.5 text-rose-600 bg-rose-50 hover:bg-rose-600 hover:text-white rounded-xl transition-all border border-rose-100 shadow-sm" title="Hapus">
                ...
                @empty
                <tr>
                    <td colspan="4" class="px-8 py-24 text-center text-gray-400 text-sm font-medium italic">Tidak ditemukan data staff.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
            ...
            <form wire:submit.prevent="{{ $isEditMode ? 'update' : 'store' }}">
                <div class="px-10 py-6 border-b border-gray-100 bg-gray-50/50 flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-[10px] text-cyan-600 font-bold uppercase tracking-[0.25em] mt-1 leading-none">Biodata Anggota Tim</p>
                    </div>
                ...
                <div class="p-10 space-y-6 max-h-[70vh] overflow-y-auto custom-scrollbar">
                    ...
                    <div class="group">
                        ...
                        <input wire:model="nama" type="text" class="w-full h-14 rounded-2xl border-gray-100 bg-gray-50 px-5 focus:border-cyan-500 font-bold text-gray-800 transition-all placeholder:text-gray-300" placeholder="Nama Staff">
                    ...
                    <div class="group">
                        ...
                        <input wire:model="email" type="email" class="w-full h-14 rounded-2xl border-gray-100 bg-gray-50 px-5 focus:border-cyan-500 font-bold text-gray-800 transition-all placeholder:text-gray-300" placeholder="email@staff.com">
                    ...
                    <div class="group">
                        <label class="block text-[11px] font-black text-gray-400 uppercase tracking-widest mb-2 ml-1">Status Keaktifan</label>
                        <div class="flex gap-4">
                            <label class="flex-1 cursor-pointer">
                                <input type="radio" wire:model="status" value="aktif" class="peer sr-only">
                                <div class="w-full h-12 flex items-center justify-center rounded-2xl border border-gray-200 bg-white text-gray-400 font-bold text-xs uppercase tracking-wider peer-checked:bg-emerald-50 peer-checked:text-emerald-600 peer-checked:border-emerald-200 transition-all shadow-sm">
                                    Aktif
                                </div>
                            </label>
                            <label class="flex-1 cursor-pointer">
                                <input type="radio" wire:model="status" value="tidak aktif" class="peer sr-only">
                                <div class="w-full h-12 flex items-center justify-center rounded-2xl border border-gray-200 bg-white text-gray-400 font-bold text-xs uppercase tracking-wider peer-checked:bg-rose-50 peer-checked:text-rose-600 peer-checked:border-rose-200 transition-all shadow-sm">
                                    Tidak Aktif
                                </div>
                            </label>
                        </div>
