    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
            ...
            <div class="mb-6 relative">
                ...
                <input wire:model.live="search" type="text" placeholder="Cari Plat Nomor, Merek, atau Tipe..."
                        ...
                        @forelse($mobils as $mobil)
                            <tr class="hover:bg-gray-50 transition duration-150">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    @else
                                        <div
                                            class="h-16 w-24 bg-gray-100 rounded-md flex items-center justify-center text-gray-400 text-xs border border-gray-200">
                                            No Image
                                        </div>
                                    @endif
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-bold text-gray-900">{{ $mobil->merek }} {{ $mobil->tipe }}
                                    </div>
                                    <div
                                        class="text-xs font-mono bg-gray-100 px-2 py-0.5 rounded inline-block mt-1 text-gray-600 border border-gray-200">
                                        {{ $mobil->id }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <span
                                        class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-50 text-blue-800 border border-blue-100">
                                        {{ ucfirst($mobil->transmisi) }}
                                    </span>
                                    <span
                                        class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-indigo-50 text-indigo-800 border border-indigo-100 ml-1">
                                        {{ $mobil->kursi }} Kursi
                                    </span>
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="text-sm font-bold text-gray-900">Rp
                                        {{ number_format($mobil->harga, 0, ',', '.') }}</div>
                                </td>
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    @php
                                    ...
                                    @endphp
                                    <span
                                        class="px-3 py-1 inline-flex text-xs leading-5 font-bold rounded-full border {{ $statusClasses }} uppercase tracking-wide">
                                        {{ $mobil->status }}
                                    </span>
                                </td>
                    ...
                    <form wire:submit.prevent="{{ $isEditMode ? 'update' : 'store' }}">
                        <div class="bg-white px-6 py-6">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                ...
                                $watch('plat_full', value => { if (value !== (prefix + ' ' + number + ' ' + suffix).trim().toUpperCase()) syncFromFull() })">
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <div class="relative w-1/4">
                                            ...
                                            <input x-model="prefix" @input="syncToFull()" type="text"
                                                placeholder="B"
                                                class="pl-8 uppercase w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-200 font-mono text-lg text-center"
                                                maxlength="2">
                                        </div>
                                        <!-- Nomor -->
                                        <div class="w-1/2">
                                            <input x-model="number" @input="syncToFull()" type="text"
                                                placeholder="1234"
                                                class="uppercase w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-200 font-mono text-lg text-center"
                                                maxlength="4">
                                        </div>
                                        <!-- Huruf Belakang -->
                                        <div class="w-1/4">
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">Format: <span
                                            class="font-mono bg-gray-100 px-1 rounded uppercase">Huruf Depan, Nomor,
                                            Huruf Belakang</span></p>
                                    @error('plat_nomor')
                                ...
                                <div>
                                    ...
                                    <input wire:model="merek" type="text" placeholder="Toyota, Honda, dll"
                                ...
                                <div>
                                    ...
                                    <input wire:model="tipe" type="text" placeholder="Avanza, Civic, dll"
                                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-200">
                                    @error('tipe')
                                        <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input wire:model="warna" type="text" placeholder="Hitam, Putih, dll"
                                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-200">
                                    @error('warna')
                                        <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span>
                                    @enderror
                                ...
                                <!-- 5. Harga -->
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Harga Sewa / Hari
                                        (Rp)</label>
                                    <div class="relative rounded-md shadow-sm">
                                        ...
                                        <input wire:model="harga" type="number" placeholder="0"
                                            class="pl-10 w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-200 text-right font-mono">
                                    </div>
                                    @error('harga')
                                        <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <select wire:model="transmisi"
                                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-200 bg-white">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                        <label class="cursor-pointer">
                                            <input type="radio" wire:model="status" value="tersedia"
                                                class="peer sr-only">
                                            <div
                                                class="text-center rounded-md border border-gray-200 py-2 px-3 hover:bg-gray-50 peer-checked:bg-green-100 peer-checked:text-green-700 peer-checked:border-green-500 transition">
                                                Tersedia
                                            </div>
                                        </label>
                                        <label class="cursor-pointer">
                                            <input type="radio" wire:model="status" value="disewa"
                                                class="peer sr-only">
                                            <div
                                                class="text-center rounded-md border border-gray-200 py-2 px-3 hover:bg-gray-50 peer-checked:bg-blue-100 peer-checked:text-blue-700 peer-checked:border-blue-500 transition">
                                                Disewa
                                            </div>
                                        </label>
                                        <label class="cursor-pointer">
                                            <input type="radio" wire:model="status" value="pemeliharaan"
                                                class="peer sr-only">
                                            <div
                                                class="text-center rounded-md border border-gray-200 py-2 px-3 hover:bg-gray-50 peer-checked:bg-red-100 peer-checked:text-red-700 peer-checked:border-red-500 transition">
                                                Service
                                            </div>
                                        </label>
                                        <label class="cursor-pointer">
                                            <input type="radio" wire:model="status" value="dibersihkan"
                                                class="peer sr-only">
                                            <div
                                                class="text-center rounded-md border border-gray-200 py-2 px-3 hover:bg-gray-50 peer-checked:bg-yellow-100 peer-checked:text-yellow-700 peer-checked:border-yellow-500 transition">
                                                Cuci
                                            </div>
                                        </label>
                                    </div>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <div
                                        class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:border-blue-400 transition bg-gray-50">
                                        <div class="space-y-1 text-center">
                                            <!-- Preview Area -->
                                            @if ($foto)
                                                <img src="{{ $foto->temporaryUrl() }}"
                                                    class="mx-auto h-48 object-cover rounded-lg shadow-md mb-3">
                                    ...
                                    <div wire:loading wire:target="foto"
                                        class="text-sm text-blue-500 mt-2 font-semibold text-center w-full animate-pulse">
                                        Sedang mengupload foto...</div>
                                    @error('foto')
                                        <span
                        ...
                        <!-- Footer Actions -->
                        <div
                            class="bg-gray-50 px-6 py-4 flex flex-row-reverse gap-3 rounded-b-xl border-t border-gray-100">
                            <button type="submit" wire:loading.attr="disabled"
                                class="w-full inline-flex justify-center rounded-lg border border-transparent shadow-sm px-4 py-2 bg-blue-600 text-base font-bold text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm disabled:opacity-50 disabled:cursor-not-allowed">
                                <span wire:loading.remove
                                    wire:target="{{ $isEditMode ? 'update' : 'store' }}">{{ $isEditMode ? 'Simpan Perubahan' : 'Simpan Data' }}</span>
                                <span wire:loading
                                    wire:target="{{ $isEditMode ? 'update' : 'store' }}">Menyimpan...</span>
                            </button>
