                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                        <label class="cursor-pointer">
                                            ...
                                            <div class="text-center rounded-md border border-gray-200 py-2 px-3 hover:bg-gray-50 peer-checked:bg-green-100 peer-checked:text-green-700 peer-checked:border-green-500 transition">Tersedia</div>
                                        </label>
                                        <label class="cursor-pointer">
                                            <input type="radio" wire:model="status" value="disewa" class="peer sr-only">
                                            <div class="text-center rounded-md border border-gray-200 py-2 px-3 hover:bg-gray-50 peer-checked:bg-blue-100 peer-checked:text-blue-700 peer-checked:border-blue-500 transition">Disewa</div>
                                        </label>
                                        <label class="cursor-pointer">
                                            <input type="radio" wire:model="status" value="pemeliharaan" class="peer sr-only">
                                            <div class="text-center rounded-md border border-gray-200 py-2 px-3 hover:bg-gray-50 peer-checked:bg-red-100 peer-checked:text-red-700 peer-checked:border-red-500 transition">Service</div>
                                        </label>
                                        <label class="cursor-pointer">
                                            <input type="radio" wire:model="status" value="dibersihkan" class="peer sr-only">
                                            <div class="text-center rounded-md border border-gray-200 py-2 px-3 hover:bg-gray-50 peer-checked:bg-yellow-100 peer-checked:text-yellow-700 peer-checked:border-yellow-500 transition">Cuci</div>
                                        </label>
                                    </div>
                        ...
                        <div class="bg-white px-6 py-6 space-y-4">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 gap-3">
                                    <label class="cursor-pointer">
                                        <input type="radio" wire:model="status_edit" value="tersedia" class="peer sr-only">
                                        <div class="rounded-md border border-gray-200 py-3 px-4 hover:bg-gray-50 peer-checked:bg-green-50 peer-checked:text-green-800 peer-checked:border-green-500 transition font-medium">✅ Tersedia (Siap Disewa)</div>
                                    </label>
                                    <label class="cursor-pointer">
                                        <input type="radio" wire:model="status_edit" value="pemeliharaan" class="peer sr-only">
                                        <div class="rounded-md border border-gray-200 py-3 px-4 hover:bg-gray-50 peer-checked:bg-red-50 peer-checked:text-red-800 peer-checked:border-red-500 transition font-medium">🔧 Pemeliharaan (Service)</div>
                                    </label>
                                    <label class="cursor-pointer">
                                        <input type="radio" wire:model="status_edit" value="dibersihkan" class="peer sr-only">
                                        <div class="rounded-md border border-gray-200 py-3 px-4 hover:bg-gray-50 peer-checked:bg-yellow-50 peer-checked:text-yellow-800 peer-checked:border-yellow-500 transition font-medium">🧼 Dibersihkan (Cuci)</div>
                                    </label>
                                </div>
                                @error('status_edit') <span class="text-red-500 text-xs mt-2 block">{{ $message }}</span> @enderror
                            </div>
                        </div>
