        ...
        <div class="flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar pb-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <label
                                ...
                                <input type="checkbox" class="sr-only peer" {{ $isChecked ? 'checked' : '' }}
                                    {{ $isLocked ? 'disabled' : '' }} wire:click="toggleStatus"
            ...
            <div class="py-4 space-y-1">
                ...
                @canany(['menu_inspeksi', 'menu_laporan_kerusakan', 'menu_logbook_sopir', 'menu_logbook_admin',
                    ...
                    @can('menu_riwayat_tugas')
                        <a href="{{ route('sopir.riwayat') }}" wire:navigate
                            class="group flex items-center px-6 py-3 transition-all duration-200 
                          {{ request()->routeIs('sopir.riwayat') ? 'bg-cyan-700 border-l-4 border-cyan-400' : 'hover:bg-cyan-700 border-l-4 border-transparent' }}"
                            title="Riwayat Tugas">
                            <svg class="h-6 w-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
