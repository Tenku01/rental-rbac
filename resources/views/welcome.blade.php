...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">
    ...
    <div class="bg-white/75 min-h-screen">
        ...
        <nav x-data="{ open: false, scrolled: false }" 
            ...
            <div class="max-w-7xl mx-auto px-6 flex justify-between items-center transition-all duration-300">
                <!-- Logo -->
                <a href="#beranda" class="flex items-center space-x-2 transform-gpu hover:scale-105 transition-transform duration-300">
                ...
                <ul class="hidden md:flex space-x-8 text-sm font-bold text-gray-800 items-center">
                    ...
                    <li><a href="#daftar-mobil" class="hover:text-cyan-600 transition-colors duration-200">Armada</a></li>
                    <li><a href="#tentang" class="hover:text-cyan-600 transition-colors duration-200">Tentang Kami</a></li>
                ...
                <!-- Tombol Hamburger -->
                <button @click="open = !open" class="md:hidden text-cyan-600 focus:outline-none transform-gpu hover:scale-110 transition-transform">
            ...
            <div x-show="open" 
                ...
                <ul class="flex flex-col text-center py-4 space-y-2 font-semibold text-gray-700">
                    <li><a href="#beranda" @click="open = false" class="block py-3 hover:text-cyan-600 hover:bg-cyan-50 transition-colors">Beranda</a></li>
                    <li><a href="#daftar-mobil" @click="open = false" class="block py-3 hover:text-cyan-600 hover:bg-cyan-50 transition-colors">Armada</a></li>
                    <li><a href="#tentang" @click="open = false" class="block py-3 hover:text-cyan-600 hover:bg-cyan-50 transition-colors">Tentang Kami</a></li>
                    <li><a href="#faq" @click="open = false" class="block py-3 hover:text-cyan-600 hover:bg-cyan-50 transition-colors">FAQ</a></li>
                    @auth
                        <li><a href="{{ url('/dashboard') }}" class="block py-3 text-cyan-600 font-bold hover:bg-cyan-50 transition-colors">Dashboard</a></li>
                    @else
                        <li class="pt-2 pb-4">
                            <a href="{{ route('login') }}"
        ...
        <div id="beranda" class="relative isolate px-6 pt-14 lg:px-8 min-h-screen flex items-center overflow-hidden">
            <div aria-hidden="true" class="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-cyan-100/40 via-transparent to-transparent"></div>
            ...
            <div class="mx-auto max-w-3xl py-32 sm:py-48 lg:py-56 text-center reveal">
                <h1 class="text-5xl font-extrabold tracking-tight text-gray-900 sm:text-7xl drop-shadow-sm">
                    Sewa Mobil <span class="text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-blue-600">Tanpa Ribet.</span>
                </h1>
                <p class="mt-8 text-lg font-medium text-gray-700 sm:text-xl/8 max-w-2xl mx-auto leading-relaxed reveal delay-100">
                    ...
                    @foreach ($mobils as $index => $mobil)
                        ...
                        >
                            ...
                            <div class="p-6 flex-1 flex flex-col">
                                ...
                                <div class="mt-auto">
                                    <div class="flex items-center justify-center w-full bg-cyan-50 text-cyan-700 border border-cyan-100 group-hover:bg-cyan-500 group-hover:text-white px-4 py-3 rounded-xl font-bold transition-colors duration-200">
                                       Pesan Sekarang <svg class="w-4 h-4 ml-2 transform-gpu group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="max-w-7xl mx-auto px-6">
                <div class="text-center mb-16 reveal">
                    ...
                    <div class="flex items-center justify-center gap-2 mt-4">
                        <svg class="w-5 h-5 text-gray-500" viewBox="0 0 24 24" fill="currentColor"><path d="M12.48 10.92v3.28h7.84c-.24 1.84-.853 3.187-1.787 4.133-1.147 1.147-2.933 2.4-6.053 2.4-4.827 0-8.6-3.893-8.6-8.72s3.773-8.72 8.6-8.72c2.6 0 4.507 1.027 5.907 2.347l2.307-2.307C18.747 1.44 16.133 0 12.48 0 5.867 0 .307 5.387.307 12s5.56 12 12.173 12c3.573 0 6.267-1.173 8.373-3.36 2.16-2.16 2.84-5.213 2.84-7.667 0-.76-.053-1.467-.173-2.053H12.48z"/></svg>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 reveal delay-100">
                        ...
                        <p class="text-gray-600 italic mb-6">"Sewa Xpander buat acara keluarga keluar kota. Mobilnya bersih, mesin sehat, AC dingin banget. Adminnya juga cepet balesnya nggak bertele-tele. Puas banget pokoknya."</p>
                        <div class="flex items-center gap-4">
                            <div class="w-12 h-12 bg-cyan-100 text-cyan-700 rounded-full flex items-center justify-center font-bold text-lg">BS</div>
                            <div>
                                <h4 class="font-bold text-gray-900">Budi Santoso</h4>
                                <span class="text-xs font-medium text-emerald-600 bg-emerald-50 px-2 py-1 rounded-md flex items-center gap-1 w-max mt-1">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> Penyewa Terverifikasi
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 reveal delay-200">
                        ...
                        <p class="text-gray-600 italic mb-6">"Saya sewa mobil plus sopir, driver-nya mas Sandi ramah banget dan tau rute alternatif waktu macet. Sangat ngebantu liburan kami yang waktunya mepet. Rekomen banget!"</p>
                        <div class="flex items-center gap-4">
                            <div class="w-12 h-12 bg-rose-100 text-rose-700 rounded-full flex items-center justify-center font-bold text-lg">SA</div>
                            <div>
                    ...
                    <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 reveal delay-300">
                        <div class="flex items-center gap-1 text-yellow-400 mb-4">
                            ...
                            <div class="relative w-5 h-5 text-gray-300">
                                <svg class="w-5 h-5 fill-current absolute" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                                <svg class="w-5 h-5 fill-current text-yellow-400 absolute overflow-hidden" style="width: 50%" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                            </div>
                        </div>
                        <p class="text-gray-600 italic mb-6">"Harga paling masuk akal di area ini. Kondisi Brio-nya masih mulus banget kaya mobil baru. Awalnya sempet ragu pas mau DP, tapi ternyata emang amanah perusahaannya."</p>
                        <div class="flex items-center gap-4">
                            <div class="w-12 h-12 bg-blue-100 text-blue-700 rounded-full flex items-center justify-center font-bold text-lg">AP</div>
                            <div>
        ...
        <section id="faq" class="bg-white py-24 relative overflow-hidden" x-data="{ selected: 1 }">
            <div class="max-w-3xl mx-auto px-6 reveal">
                ...
                <div class="space-y-4">
                    <!-- Pertanyaan 1 -->
                    <div class="border border-gray-200 rounded-2xl overflow-hidden transition-all duration-300" :class="selected == 1 ? 'border-cyan-500 shadow-md ring-1 ring-cyan-500' : 'hover:border-gray-300'">
                        <button @click="selected !== 1 ? selected = 1 : selected = null" class="w-full text-left px-6 py-5 flex justify-between items-center focus:outline-none bg-white">
                            <span class="font-bold text-gray-900" :class="selected == 1 ? 'text-cyan-600' : ''">Apa saja syarat untuk menyewa mobil lepas kunci?</span>
                            <svg class="w-5 h-5 text-gray-500 transform transition-transform duration-300" :class="selected == 1 ? 'rotate-180 text-cyan-600' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                        </button>
                    ...
                    <!-- Pertanyaan 2 -->
                    <div class="border border-gray-200 rounded-2xl overflow-hidden transition-all duration-300" :class="selected == 2 ? 'border-cyan-500 shadow-md ring-1 ring-cyan-500' : 'hover:border-gray-300'">
                        <button @click="selected !== 2 ? selected = 2 : selected = null" class="w-full text-left px-6 py-5 flex justify-between items-center focus:outline-none bg-white">
                            <span class="font-bold text-gray-900" :class="selected == 2 ? 'text-cyan-600' : ''">Apakah harga sewa sudah termasuk BBM dan Tol?</span>
                            <svg class="w-5 h-5 text-gray-500 transform transition-transform duration-300" :class="selected == 2 ? 'rotate-180 text-cyan-600' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                        </button>
                    ...
                    <!-- Pertanyaan 3 -->
                    <div class="border border-gray-200 rounded-2xl overflow-hidden transition-all duration-300" :class="selected == 3 ? 'border-cyan-500 shadow-md ring-1 ring-cyan-500' : 'hover:border-gray-300'">
                        <button @click="selected !== 3 ? selected = 3 : selected = null" class="w-full text-left px-6 py-5 flex justify-between items-center focus:outline-none bg-white">
                            <span class="font-bold text-gray-900" :class="selected == 3 ? 'text-cyan-600' : ''">Bagaimana sistem denda jika saya terlambat mengembalikan mobil?</span>
                            <svg class="w-5 h-5 text-gray-500 transform transition-transform duration-300" :class="selected == 3 ? 'rotate-180 text-cyan-600' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                        </button>
                        <div x-show="selected == 3" x-collapse>
                            <div class="px-6 pb-5 pt-1 text-gray-600 text-sm leading-relaxed border-t border-gray-100">
                                Denda keterlambatan akan dikenakan 10% per jam dari harga sewa per hari. Sebagai contoh, jika harga sewa per hari adalah Rp 100.000, maka untuk setiap jam keterlambatan akan dikenakan 10% nya yaitu Rp 10.000.
                            </div>
                        </div>
                    </div>

                    <!-- Pertanyaan 4 -->
                    <div class="border border-gray-200 rounded-2xl overflow-hidden transition-all duration-300" :class="selected == 4 ? 'border-cyan-500 shadow-md ring-1 ring-cyan-500' : 'hover:border-gray-300'">
                        <button @click="selected !== 4 ? selected = 4 : selected = null" class="w-full text-left px-6 py-5 flex justify-between items-center focus:outline-none bg-white">
                            <span class="font-bold text-gray-900" :class="selected == 4 ? 'text-cyan-600' : ''">Apakah bisa pesan (booking) mendadak di hari H?</span>
                            <svg class="w-5 h-5 text-gray-500 transform transition-transform duration-300" :class="selected == 4 ? 'rotate-180 text-cyan-600' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                        </button>
                        <div x-show="selected == 4" x-collapse>
                            <div class="px-6 pb-5 pt-1 text-gray-600 text-sm leading-relaxed border-t border-gray-100">
                                Sangat bisa, asalkan unit mobil masih berstatus "Tersedia". Namun, kami sangat menyarankan untuk booking maksimal H-1 agar kami dapat menyiapkan kendaraan dengan lebih optimal untuk Anda.
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <footer class="bg-gray-900 border-t border-gray-800 text-gray-300">
            <div class="max-w-7xl mx-auto px-6 py-16">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 reveal">
                    ...
                    <div class="col-span-1 md:col-span-2">
                        <a href="#beranda" class="flex items-center space-x-2 mb-6">
                            <h2 class="text-2xl font-extrabold text-white">AKA<span class="text-cyan-500">RENT</span></h2>
                        </a>
                        <p class="text-sm text-gray-400 mb-6 leading-relaxed max-w-sm">
                            Solusi transportasi tepercaya Anda. Kami menyediakan layanan sewa kendaraan kualitas terbaik dengan proses yang aman, cepat, dan transparan.
                        </p>
                        <!-- Social Media -->
                        <div class="flex space-x-4">
                            <a href="#" class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-cyan-600 hover:text-white transition-colors">
                    ...
                    <div class="col-span-1">
                        ...
                        <ul class="space-y-3 text-sm text-gray-400">
                            ...
                            <li><a href="#daftar-mobil" class="hover:text-cyan-400 transition-colors">Daftar Armada</a></li>
                    ...
                    <div class="col-span-1">
                        ...
                        <ul class="space-y-4 text-sm text-gray-400">
                            <li class="flex items-start gap-3">
                                ...
                                <span>Sapen, Jl. Bimasakti No.70, Demangan, Kec. Gondokusuman, Kota Yogyakarta, Daerah Istimewa Yogyakarta 55221</span>
                            </li>
                ...
                <div class="mt-16 pt-8 border-t border-gray-800 text-center flex flex-col md:flex-row justify-between items-center gap-4 reveal delay-100">
                    <p class="text-xs text-gray-500">&copy; {{ date('Y') }} Aka Rental Mobil. Semua Hak Dilindungi.</p>
    ...
    <div x-data="guestChat" class="fixed bottom-6 right-6 z-50 flex flex-col items-end">
        ...
        <div x-show="chatOpen" 
            ...
            <div class="bg-cyan-600 text-white p-4 flex justify-between items-center">
                <div class="flex items-center gap-3">
                    <div class="relative">
                        ...
                        <span class="absolute bottom-0 right-0 w-3 h-3 bg-green-400 border-2 border-cyan-600 rounded-full"></span>
                    </div>
                    <div>
            ...
            <div id="chat-body" class="p-4 bg-gray-50 h-64 overflow-y-auto flex flex-col gap-3 custom-scrollbar">
                ...
                <template x-for="msg in messages" :key="msg.id || msg.waktu">
                    <div class="w-full flex flex-col">
                        ...
                        <div x-show="msg.pengirim_id === null" class="flex justify-end gap-2 w-full mt-2">
                            <div class="bg-cyan-600 text-white p-3 rounded-2xl rounded-tr-none shadow-sm text-sm break-words max-w-[85%]">
                        ...
                        <div x-show="msg.pengirim_id !== null" class="flex gap-2 w-full mt-2">
                            <div class="w-8 h-8 rounded-full bg-cyan-100 flex-shrink-0 flex items-center justify-center text-cyan-700 font-bold text-xs">CS</div>
                            <div class="bg-white border border-gray-100 p-3 rounded-2xl rounded-tl-none shadow-sm text-sm text-gray-700 break-words max-w-[85%]">
                                <span x-text="msg.isi_pesan"></span>
                ...
                <div x-show="messages.length === 0" class="flex gap-2 mt-2">
                    <div class="w-8 h-8 rounded-full bg-cyan-100 flex-shrink-0 flex items-center justify-center text-cyan-700 font-bold text-xs">CS</div>
                    <div class="bg-white border border-gray-100 p-3 rounded-2xl rounded-tl-none shadow-sm text-sm text-gray-700">
            ...
            <div class="p-3 bg-white border-t border-gray-100">
                <form @submit.prevent="sendMessage" class="flex items-center gap-2">
                    ...
                    <button type="submit" class="bg-cyan-600 hover:bg-cyan-700 text-white p-2.5 rounded-xl transition-colors shrink-0">
                ...
                <p class="text-center text-[10px] text-gray-400 mt-2">Ngobrol langsung dengan CS. Anda tidak perlu login.</p>
            </div>
        </div>
        ...
        <button @click="chatOpen = !chatOpen" 
            ...
            <svg x-show="!chatOpen" class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z"></path></svg>
            <svg x-show="chatOpen" class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="display: none;"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
        </button>
    </div>
                ...
                init() {
                    ...
                    setTimeout(() => {
                        if (window.Echo) {
                            ...
                            console.error("Laravel Echo belum ter-load!");
                        }
                    }, 1000); 
                },
